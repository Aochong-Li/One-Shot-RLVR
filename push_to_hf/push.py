...
def push_model_to_hf(model_name: str, local_checkpoint_dir: str):
...
def push_dataset_to_hf(dataset_name: str, local_dataset_dir: str):
...
if __name__ == "__main__":
    ...
    python push_to_hf/push.py --dataset_name "superrl_4096" --local_dataset_dir "/share/goyal/lio/reasoning/data/superrl_4096"
    """
