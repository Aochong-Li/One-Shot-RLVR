...
if __name__ == "__main__":
    """
    Example usage:
    python push_to_hf/push.py --task push_local_model --model_name "R1-Distill-Qwen-1.5B-DeepMath-stage2-grpo-level3-4-5epochs-4rollouts-8192max-length-global_step_255" --local_checkpoint_dir "outputs/deepmath/R1-Distill-Qwen-1.5B-DeepMath-stage2-grpo-level3-4-5epochs-4rollouts-8192max-length/global_step_255/actor"
    python push_to_hf/push.py --task push_local_dataset --dataset_name "deepmath_4096" --local_dataset_dir "/share/goyal/lio/reasoning/data/deepmath_4096"
    
    python push_to_hf/push.py --task update_base_model_tokenizer --model_name "Qwen2.5-3B-Zero-Base" --local_checkpoint_dir "Qwen/Qwen2.5-3B"
    """
