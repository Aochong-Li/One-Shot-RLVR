...
EXPERIMENT_NAME="Qwen2.5-3B-countdown-level-5-${TOTAL_EPOCHS}epochs-${ROLLOUT_N}rollouts-${MAX_LENGTH}max-length-stage2-randomthoughts-only"

python3 -m verl.trainer.main_ppo \
 algorithm.adv_estimator=grpo \
 data.train_files=data/train/countdown_level5_random_thought_only_15k/train.parquet \
 data.val_files=data/train/countdown_level5_random_thought_only_15k/test.parquet \
