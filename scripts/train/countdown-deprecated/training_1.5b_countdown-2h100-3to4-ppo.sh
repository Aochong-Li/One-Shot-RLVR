...
EXPERIMENT_NAME="Qwen2.5-3B-countdown-level3to4-${TOTAL_EPOCHS}epochs-${ROLLOUT_N}rollouts-${MAX_LENGTH}max-length"

python3 -m verl.trainer.main_ppo \
 algorithm.adv_estimator=gae \
 data.train_files=data/train/countdown-3to4/train.parquet \
 data.val_files=data/train/countdown-3to4/test.parquet \
