...
TOTAL_EPOCHS=5 # 20000 * 5 / 128 = 781 steps
...
for TEMPERATURE in ${TEMPERATURES}; do
    EXPERIMENT_NAME="R1-Distill-Qwen-1.5B-deepmath-level5-6-max-length-${MAX_LENGTH}-rollout-${ROLLOUT_N}-temperature-${TEMPERATURE}"

    python3 -m verl.trainer.main_ppo \
            algorithm.adv_estimator=grpo \
            data.train_files=data/train/deepmath_level5-9/train.parquet \
