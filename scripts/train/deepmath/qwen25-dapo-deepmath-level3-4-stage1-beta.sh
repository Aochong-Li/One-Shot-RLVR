...
export BASE_MODEL="aochongoliverli/Qwen2.5-1.5B-DeepMath-level1-4-40k-all_rollouts-sft-stage0-step-200"

N_GPUS=1
ROLLOUT_N=3
MAX_LENGTH=1024
VALIDATION_MAX_LENGTH=4096
...
OVERLONG_BUFFER_PENALTY_FACTOR=0.25

EXPERIMENT_NAME="beta-test-deepmath-stage1-dapo"

python3 -m verl.trainer.main_dapo_debug \
