...
EXPERIMENT_NAME="Qwen2.5-3B-countdown-level5-30k-grpo-stage1-${TOTAL_EPOCHS}epochs-${ROLLOUT_N}rollouts-${MAX_LENGTH}max-length"

python3 -m verl.trainer.main_ppo \
 algorithm.adv_estimator=grpo \
 data.train_files=data/train/countdown_level5_30k/train.parquet \
 data.val_files=data/test/countdown_level67_500/test.parquet \
