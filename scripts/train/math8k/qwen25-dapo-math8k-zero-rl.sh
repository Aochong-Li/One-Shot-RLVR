...
export BASE_MODEL="aochongoliverli/Qwen2.5-3B-Zero-Base"
...
EXPERIMENT_NAME="Qwen2.5-3B-math8k-dapo-${TOTAL_EPOCHS}epochs-${ROLLOUT_N}rollouts-${MAX_LENGTH}max-len"
