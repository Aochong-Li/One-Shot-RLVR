...
EXPERIMENT_NAME="Qwen2.5-3B-math8k-grpo-${TOTAL_EPOCHS}epochs-${ROLLOUT_N}rollouts-${MAX_LENGTH}max-length"

python3 -m verl.trainer.main_ppo \
 algorithm.adv_estimator=grpo \
 data.train_files=data/train/math.8k/train.parquet \
 data.val_files=data/train/math.8k/test.parquet \
 ...
 trainer.project_name='math8k-octothink'\
